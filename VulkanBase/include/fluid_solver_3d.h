...
class FluidSolver3D : public FluidSolver {
public:
    FluidSolver3D() = default;

    FluidSolver3D(VulkanDevice* device, VulkanDescriptorPool* descriptorPool,
...
public:
    ...
    void jacobiIteration(VkCommandBuffer commandBuffer, VkDescriptorSet unknownDescriptor,
...
private:
    ...
    void drawVolume(VkCommandBuffer commandBuffer) const;

    VkImageView createAttachmentView(Texture& texture);
    ...
    std::vector<VulkanImageView> attachmentViews;
};
