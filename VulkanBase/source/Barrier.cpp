...
void Barrier::computeWriteToHostRead(VkCommandBuffer commandBuffer) {
    VkMemoryBarrier barrier{};
...
void Barrier::computeReadToTransferWrite(VkCommandBuffer commandBuffer) {
    VkMemoryBarrier barrier{};
...
void Barrier::transferWriteToComputeWrite(VkCommandBuffer commandBuffer, const VulkanBuffer& buffer) {
    VkBufferMemoryBarrier barrier{};
...
void Barrier::transferWriteToComputeWrite(VkCommandBuffer commandBuffer) {
    VkMemoryBarrier barrier{};
...
void Barrier::transferReadWriteToComputeReadWrite(VkCommandBuffer commandBuffer) {
    VkMemoryBarrier barrier{};
...
void Barrier::fragmentWriteToComputeRead(VkCommandBuffer commandBuffer) {
    VkMemoryBarrier barrier{};
...
void Barrier::fragmentWriteToFragmentRead(VkCommandBuffer commandBuffer) {
    VkMemoryBarrier barrier{};
...
void Barrier::fragmentReadToFragmentWrite(VkCommandBuffer commandBuffer) {
    VkMemoryBarrier barrier{};
...
void Barrier::rayTraceWriteToFragmentRead(VkCommandBuffer commandBuffer) {
    static VkMemoryBarrier2 barrier{
        .sType = VK_STRUCTURE_TYPE_MEMORY_BARRIER_2,
        .srcStageMask = VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR,
        .srcAccessMask = VK_ACCESS_SHADER_WRITE_BIT,
